...
export class PofinancetrackerComponent implements OnInit {
  ...
  constructor(private router: Router,public CS:CommonService,private objservice:POfinancetrackerService,public http:HttpClient,private ngxService: NgxUiLoaderService) { }
  public userdtl;
  public user;
